...
namespace MetricDataIntegrator
{
    ...
    class Program
    {
        ...
        {
            string projectPath = @"PROJECT_PATH"; //For example, @"D:\GitHub\TCmetricsGenerator\Projects\Cli"
            ...
            string TestPathFilePath = @"D:\GitHub\MetricsDataIntegrator\TP_dataset_resulting_" + projectPath.Substring(projectPath.LastIndexOf(@"\") + 1) + ".csv";
            string TestCaseFilePath = @"D:\GitHub\MetricsIntegrator\TC_dataset_resulting_" + projectPath.Substring(projectPath.LastIndexOf(@"\") + 1) + ".csv";
